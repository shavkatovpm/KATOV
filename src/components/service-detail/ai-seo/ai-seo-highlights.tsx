...
interface AiSeoHighlightsProps {
...
> = {
  uz: {
    title: 'Raqamlar aniq, jarayon shaffof',
    lead: "AI SEO'da ham nima uchun qancha to'layotganingiz va qachon natija ko'rishingiz aniq bo'lishi kerak.",
    deliverablesLabel: 'paket punktlari',
    firstResultValue: '1–3 oy',
    firstResultLabel: 'birinchi natija',
    monthlyValue: 'Har oy',
    monthlyLabel: "AI'da test qilinadi",
    priceLabel: "boshlang'ich narx",
  },
  ru: {
    title: 'Цифры точны, процесс прозрачен',
    lead: 'В AI SEO тоже должно быть ясно, за что вы платите и когда увидите результат.',
    deliverablesLabel: 'пунктов пакета',
    firstResultValue: '1–3 мес',
    firstResultLabel: 'первый результат',
    monthlyValue: 'Каждый месяц',
    monthlyLabel: 'тест в AI',
    priceLabel: 'стартовая цена',
  },
  en: {
    title: 'Clear numbers, transparent process',
    lead: 'AI SEO should be just as clear about what you are paying for and when results show up.',
    deliverablesLabel: 'package items',
    firstResultValue: '1–3 mo',
    firstResultLabel: 'first result',
    monthlyValue: 'Every month',
    monthlyLabel: 'tested in AI',
...
export function AiSeoHighlights({ content, basePrice, locale }: AiSeoHighlightsProps) {
  const t = copy[locale];
