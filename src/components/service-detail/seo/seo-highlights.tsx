...
> = {
  uz: {
    title: 'Aniq raqamlar, aniq jarayon',
    lead: "SEO xizmatida nima uchun qancha to'layotganingiz va qachon natija ko'rishingiz aniq bo'lishi kerak.",
    deliverablesLabel: 'paket punktlari',
    firstResultValue: '2–3 oy',
    firstResultLabel: 'birinchi natija',
    monthlyValue: 'Har oy',
    monthlyLabel: 'raqamli hisobot',
    priceLabel: "boshlang'ich narx",
  },
  ru: {
    title: 'Точные цифры, понятный процесс',
    lead: 'В SEO должно быть ясно, за что вы платите и когда увидите результат.',
    deliverablesLabel: 'пунктов пакета',
    firstResultValue: '2–3 мес',
    firstResultLabel: 'первый результат',
    monthlyValue: 'Каждый месяц',
    monthlyLabel: 'отчёт в цифрах',
    priceLabel: 'стартовая цена',
  },
  en: {
    title: 'Clear numbers, clear process',
    lead: 'SEO should make it obvious what you are paying for and when results show up.',
    deliverablesLabel: 'package items',
    firstResultValue: '2–3 mo',
    firstResultLabel: 'first result',
    monthlyValue: 'Every month',
    monthlyLabel: 'numeric report',
...
export function SeoHighlights({ content, basePrice, locale }: SeoHighlightsProps) {
  const t = copy[locale];
