...
// Existing deliverable copy reads "Short label — detail clause". Splitting
// it lets the label carry bold visual weight while the detail stays small
...
export function SeoDeliverables({ content }: SeoDeliverablesProps) {
  return (
