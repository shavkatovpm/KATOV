...
export function FluidCursor() {
  ...
  useEffect(() => {
    ...
    function generateColor() {
      // Project grey tones: #dddddd (0.867) to #767676 (0.463)
      const greyValue = 0.463 + Math.random() * (0.867 - 0.463);
      const intensity = 0.15;
      return {
        r: greyValue * intensity,
        g: greyValue * intensity,
        b: greyValue * intensity,
      };
    }
