...
export default async function BlogPostPage({ params }: BlogPostPageProps) {
  ...
  if (slugMapping && slugMapping[locale] && slugMapping[locale] !== slug) {
    ...
    redirect(`${prefix}/blog/${slugMapping[locale]}`);
  }
  ...
  const priceCTATexts: Record<string, { question: string; note: string; buttonCalc: string; buttonOrder: string }> = {
    uz: {
